...
//!
//! - X11: Tauri's GlobalShortcut plugin (X11 key grab).
//! - Wayland: XDG Desktop Portal + Hyprland-native bindings via `portal` module.
...
///
/// On Wayland, routes through the portal module (Hyprland uses native binds).
